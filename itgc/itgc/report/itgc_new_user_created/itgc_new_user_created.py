...
def get_columns():
	return [{'fieldname': 'id', 'label': 'User', 'fieldtype': 'Link', 'options': 'User', 'width': 240}, {'fieldname': 'email', 'label': 'Email', 'fieldtype': 'Data', 'width': 220}, {'fieldname': 'user_type', 'label': 'User Type', 'fieldtype': 'Data', 'width': 140}, {'fieldname': 'username', 'label': 'Username', 'fieldtype': 'Data', 'width': 160}, {'fieldname': 'full_name', 'label': 'Full Name', 'fieldtype': 'Data', 'width': 200}, {'fieldname': 'created_on', 'label': 'Created On', 'fieldtype': 'Datetime', 'width': 160}, {'fieldname': 'created_by', 'label': 'Created By', 'fieldtype': 'Link', 'options': 'User', 'width': 200}, {'fieldname': 'cnt', 'label': 'Count', 'fieldtype': 'Int', 'width': 80}]
